...
input_file   <- "C:\\Users\\jpark\\vscode\\Hackathon_Rabo_2025\\src\\02_create_categories\\data\\monthly_data_categorized.csv"
output_file  <- "C:\\Users\\jpark\\vscode\\Hackathon_Rabo_2025\\src\\02_create_categories\\data\\monthly_data_categorized_extended_useThis.csv"
...
for(colName in data_columns){ 
  ...
  # for testing
  #colName <- "Bankruptcies_Bankruptcies"
...
monthly_combined_extended <- list_of_forecasts %>% reduce(full_join, by = "date")


write.csv(monthly_combined_extended, output_file, row.names = FALSE)