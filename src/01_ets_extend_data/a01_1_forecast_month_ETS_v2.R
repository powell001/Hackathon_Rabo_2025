...
input_file     <- "C:/Users/jpark/vscode/Hackathon_Rabo_2025/data/02_processed_data/a0_combinedMonthly_use_this.csv"
output_folders <- "C:/Users/jpark/vscode/Hackathon_Rabo_2025/data/03_final_data/mo_data_extended/"
...
print('################################')
print('a01_1_forecast_month_ETS_v2')
...
figures_dir  <- "C:/Users/jpark/vscode/Hackathon_Rabo_2025/data/03_final_data/mo_data_extended/figures/"
...
for(colName in data_columns){ 
  ...
  # test case
  #colName <- "United.States_unemply_M"
